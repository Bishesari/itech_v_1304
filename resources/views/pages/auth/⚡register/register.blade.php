<div>
    ...
    <form wire:submit.prevent="check_inputs" class="flex flex-col gap-6 mt-5 mb-3" autocomplete="off">

        <x-my.flt-lbl name="first_name_fa" label="{{ __('نام:') }}" maxlength="40" class="tracking-widest font-semibold"
            autofocus required />

        <x-my.flt-lbl name="l_name_fa" label="{{ __('نام خانوادگی:') }}" maxlength="40"
            class="tracking-wider font-semibold" required />

        <x-my.flt-lbl name="n_code" label="{{ __('کدملی:') }}" dir="ltr" maxlength="10"
            class="tracking-wider font-semibold" required />
        <x-my.flt-lbl name="contact_value" label="{{ __('شماره موبایل:') }}" dir="ltr" maxlength="11"
            class="tracking-wider font-semibold" required />
